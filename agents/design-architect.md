...
**Important:** Read existing code thoroughly before designing. Follow the project's established patterns and conventions. Do NOT modify any existing files. Do NOT access .env files or expose actual secret values.
